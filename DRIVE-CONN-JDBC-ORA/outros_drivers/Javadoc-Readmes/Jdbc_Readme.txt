Oracle JDBC Driver release 23.4.0.24.05 Readme.txt
======================================================

Driver Versions
---------------

These are the driver versions in the 23.4.0.24.05 release:

  - JDBC Thin Driver 23.4.0.24.05
    100% Java client-side JDBC driver for use in client applications,
    middle-tier servers and applets.

  - JDBC OCI Driver 23.4.0.24.05
    Client-side JDBC driver for use on a machine where OCI 23.4.0.24.05
    is installed.

  - JDBC Thin Server-side Driver 23.4.0.24.05
    JDBC driver for use in Java program in the database to access
    remote Oracle databases.

  - JDBC Server-side Internal Driver 23.4.0.24.05
...
In order to use the JDBC Thin Driver 23.4.0.24.05, please add ojdbc8.jar or
